...
# Print out the dimensions of the dataframe and the first 10 rows.
shape = df_homes.shape
print(f"The homes data had {shape[0]} rows and {shape[1]} columns.")

# Select only the homes with more than 500 units.
